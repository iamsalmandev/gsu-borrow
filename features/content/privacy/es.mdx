...
This Privacy Policy provides our privacy policy regarding the nature, purpose, use, and sharing of personal data or other information collected from the users of the gsucoin.app website and other websites which use subdomains of gsucoin.app (the "Site"). We are committed to protecting and respecting your privacy. Please read this carefully as this Privacy Policy is legally binding when you use the Site.

As used in this Privacy Policy, "we", "us" or "our" refers to GSU Protocol Lab ApS, a company incorporated and registered in Denmark. You can reach us with any requests relating to this Privacy Policy via the contact details provided below.
...
You may contact us by email at the following email address: [**legal@gsucoin.app.**](mailto:legal@gsucoin.app.) We use the data that you provide in an email to us, which you may give voluntarily, only in order to answer your contact question or to reply to your email in the best possible manner.
...
Please contact us with questions, comments, or concerns regarding our Privacy Policy as well as with any requests at [**legal@gsucoin.app**](mailto:legal@gsucoin.app).