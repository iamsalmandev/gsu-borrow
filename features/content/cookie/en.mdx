...
_Last updated: August 11th 2022_

This Policy provides our Cookie Policy regarding the nature, purpose, use, and sharing of personal data or other information collected from the users through cookies and other tracking technologies on the gsucoin.app website and other websites which use subdomains of gsucoin.app (the "Site"). We are committed to protecting and respecting your privacy. Please read this carefully as this Cookie Policy is legally binding when you use the Site.

As used in this Cookie Policy, "we", "us" or "our" refers to GSU Protocol Lab ApS, a company incorporated and registered in Denmark. You can reach us with any requests relating to this Cookie Policy via the contact details provided below.
...
We use third party service providers, to assist us in better understanding the use of our Site. Our service providers will place cookies on the hard drive of your computer (or use similar tracking technologies, together: "Cookies") and will receive information that we select that will educate us on such things as how visitors navigate around our Site. This information is aggregated to provide statistical data about our users' browsing actions and patterns, and does not personally identify individuals. This information may include:
...
You can prevent storage of cookies on your browser by refusing cookies or by changing your browser settings. Most browsers will tell you how to stop accepting new cookies, how to be notified when you receive a new cookie, and how to disable existing cookies. Please note that when you disable cookies, some features and services on the Site may not function properly and may cancel opt-outs that rely on cookies, such as web analytics.
...
The "Private Browsing" mode, offered today by all browsers, mainly allows you to browse the Internet without keeping a history of the pages visited or downloads. As far as cookies are concerned, all those recorded during your browsing will be deleted when you close your browser. It is therefore not a solution that allows you to refuse cookies; however, their life span is limited to the duration of your browsing.
...
| --- | --- | --- | --- | --- |
| gsucoin.app | First party | Next-i18next | Sets the language setting of the application | Session |
| --- | --- | --- | --- | --- |
...
| **Cookie subgroup** | **Domain** | **Cookie(s) name** | **Purpose** | **Duration** |
| --- | --- | --- | --- | --- |
| Groove | Third party | \_ga\_B62KEY1NJQ | Analytics of the knowledge base | 22 months |
| --- | --- | --- | --- | --- |
...
| Groove | Third party | \_groove\_session\_2 | Analytics of the knowledge base | Session |
| Mixpanel | Third party | mp\_5372a8300dc764fd08c9bd883eaf6 | Analytics for Oasis.app | 12 months |
| Mixpanel | Third party | mp\_b10850880cb0a8557d878c2e602 | Analytics for Oasis.app | 12 months |
| Mixpanel | Third party | mp\_eceeaac79053a2f9538c8e404607c4 | Analytics for Oasis.app | 12 months |
...
| **Cookie subgroup** | **Domain** | **Cookie(s) name** | **Purpose** | **Duration** |
| --- | --- | --- | --- | --- |
| Adroll | Third party | \_\_adroll\_fpc | Marketing (retargeting) | 12 months |
| --- | --- | --- | --- | --- |
| Adroll | Third party | \_\_ar\_v4 | Marketing (retargeting) | 12 months |

**Amendments to this Policy**

We may amend this Cookie Policy at any time by posting the amended version on the Site including the effective date of the amended version. We will post the updated Cookie Policy on the Site, and ask for your consent to the changes when legally required.

**Conflict or Inconsistency**

In the event of any conflict or inconsistency between this Cookie Policy and any non-English language translation thereof, the terms and provisions of this Cookie Policy shall control.

**Contact**

Please contact us with questions, comments, or concerns regarding our Cookie Policy as well as with any requests at [**legal@gsucoin.app**](mailto:legal@gsucoin.app).